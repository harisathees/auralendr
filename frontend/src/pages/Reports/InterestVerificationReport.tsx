...
const InterestVerificationReport = () => {
    ...
    const fetchReport = async () => {
        ...
        try {
            ...
            const response = await api.get('/reports/verification/interest', { params });
    ...
    const totalInterestVisible = loans.reduce((sum, l) => sum + (l.verification?.interest || 0), 0);
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] md:text-xs text-gray-500 dark:text-gray-400 font-medium">
                            Jumping Month Logic Verification
                        </p>
                    </div>
                </div>

                <div className="flex items-center gap-2">
                    <span className="text-[10px] font-bold text-orange-600 uppercase bg-orange-50 dark:bg-orange-900/20 px-2 py-1 rounded-md">
                        {status}
                    </span>
                        ...
                        <table className="w-full text-left whitespace-nowrap">
                            <thead className="bg-gray-50 dark:bg-gray-800/50 text-gray-500 dark:text-gray-400 uppercase font-bold text-xs md:text-sm border-b border-gray-200 dark:border-gray-800">
                                <tr>
                                    ...
                                    <th className="px-2 py-2 md:px-4 md:py-3 text-right">Balance</th>
                                    ...
                                    loans.map((l, index) => {
                                        ...
                                        return (
                                            <tr key={l.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                                                ...
                                                <td className="px-2 py-2 md:px-4 md:py-3 text-center font-bold text-blue-600 bg-blue-50 dark:bg-blue-900/10 rounded-md mx-auto w-fit px-2 text-sm">
                                                    {v?.duration}
                                                </td>
                            ...
                            <tfoot className="bg-gray-50 dark:bg-gray-800 border-t-2 border-gray-200 dark:border-gray-700">
                                <tr>
                                    <td colSpan={5} className="px-2 py-3 text-right font-black uppercase text-gray-600 dark:text-gray-300 text-xs">
                                        Page Total Interest:
                                    </td>
...
export default InterestVerificationReport;

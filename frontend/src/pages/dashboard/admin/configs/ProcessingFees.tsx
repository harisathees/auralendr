    ...
    return (
        <div className="p-6">
            <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                    <h2 className="text-2xl font-bold bg-gradient-to-r from-primary to-primary-dark bg-clip-text text-transparent">Loan Processing Fee</h2>
                    <p className="text-sm text-secondary-text">Manage document charges and processing fees</p>
                </div>
            </div>

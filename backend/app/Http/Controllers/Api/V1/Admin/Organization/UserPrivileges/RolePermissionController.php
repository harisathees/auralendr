...
class RolePermissionController extends Controller
{
    ...
    public function getUsersByRole(Request $request)
    {
        ...
        $users = \App\Models\Admin\Organization\User\User::where('role', $role)
            ->when($targetBranchId !== null && $targetBranchId !== '', function ($q) use ($targetBranchId) {
    ...
    public function updateUserPermissions(Request $request, \App\Models\Admin\Organization\User\User $user)
    {
        $request->validate([
            'permissions' => 'array'
        ]);
